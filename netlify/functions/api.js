// Netlify Function: Portal ATRIA API Proxy with CORRECT script ID
...
exports.handler = async (event) => {
  ...
  try {
    ...
    if (!match) {
      return { statusCode: 502, headers: { 'Content-Type': 'application/json', 'Access-Control-Allow-Origin': '*' }, body: JSON.stringify({ error: true, errorTitle: 'API indisponivel', errorMessage: 'Erro no servidor ATRIA.' }) };
    }
